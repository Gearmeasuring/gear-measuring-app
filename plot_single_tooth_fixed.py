...
def plot_single_tooth_fixed():
    ...
    # 计算第一齿的角度范围
    min_angle = min(first_tooth_angles)
    max_angle = max(first_tooth_angles)
    print(f"First tooth angle range: {min_angle:.2f} to {max_angle:.2f} degrees")
    
    # 创建PDF报告
    output_pdf = 'single_tooth_profile_263751-018-WAV_fixed.pdf'
    ...
    print(f"Fixed single tooth profile analysis completed. Results saved to: {output_pdf}")


if __name__ == '__main__':
    plot_single_tooth_fixed()
