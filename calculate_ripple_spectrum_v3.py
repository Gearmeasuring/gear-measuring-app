...
def analyze_ripple(mka_file):
    ...
    print(f"\n【评价范围】")
    print(f"  Profile: {profile_eval_start} ~ {profile_eval_end} mm")
    print(f"  Helix: {helix_eval_start} ~ {helix_eval_end} mm")
    ...
    plt.tight_layout()
    plt.savefig('ripple_spectrum_analysis_v3.png', dpi=150, bbox_inches='tight')
    print(f"\n\n频谱分析图已保存: ripple_spectrum_analysis_v3.png")
    plt.show()
